...
local widget_icon = wibox.widget {
	...
	{
		id = 'icon',
		image = icons.volume:gsub(colors.icons, main_color),
		resize = true,
...
local update_slider_mute = function()
	awful.spawn.easy_async_with_shell(
		...
		function(stdout)
			...
			if status == 'true' then
				widget_icon.icon:set_image(icons.mute:gsub(colors.icons, main_color))
			elseif status == "false" then
				widget_icon.icon:set_image(icons.volume:gsub(colors.icons, main_color))
			end
		end
	)
end
...
awesome.connect_signal(
	...
	function()
		update_slider()
		update_slider_mute()
		awesome.emit_signal('volumeCenter::volumeSlider:update')
	end
)
