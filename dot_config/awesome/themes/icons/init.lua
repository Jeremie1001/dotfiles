...
return {
	...
	brightness 			= require(dir .. 'brightness'):gsub("#ffffff", colors.icons),
	...
	globe			= require(dir .. 'globe'):gsub("#ffffff", colors.icons),
	headphones			= require(dir .. 'headphones'):gsub("#ffffff", colors.icons),
	keyboard			= require(dir .. 'keyboard'):gsub("#ffffff", colors.icons),
	language			= require(dir .. 'language'):gsub("#ffffff", colors.icons),
	...
	plug 				= require(dir .. 'plug'):gsub("#ffffff", colors.icons),
	...
	system			= require(dir .. 'system'):gsub("#ffffff", colors.icons),
