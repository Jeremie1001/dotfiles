...
awesome.connect_signal(
  ...
  function(bar, i, cycleStatus, count)
    ...
    if calendarPanel.visible and i == #bar then 
      calendarPanel.visible = false
      awesome.emit_signal(bar[1].."::center:tab",bar, 1, true, count)
    elseif calendarPanel.visible then
      calendarPanel.visible = false
      awesome.emit_signal(bar[i+1].."::center:tab",bar,i+1, true, count+1)
    elseif calendarPanel.visible == false and i ~= #bar then 
...
awesome.connect_signal(
  "cal::center:tab:reverse",
  function(bar, i, cycleStatus, count)
    if cycleStatus then
      calendarPanel.visible = true
      return
    end
    if calendarPanel.visible and i == 1 then 
      calendarPanel.visible = false
    ...
    elseif calendarPanel.visible == false and i ~= 1 then 
